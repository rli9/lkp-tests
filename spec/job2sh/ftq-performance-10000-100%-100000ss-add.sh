...
export_top_env()
{
	...
	export enqueue_time='2025-01-23 01:03:15 +0800'
...
run_job()
{
	...
	run_test test='add' freq=10000 $LKP_SRC/programs/wrappers/tests ftq
}
...
extract_stats()
{
	...
	env test='add' freq=10000 $LKP_SRC/programs/wrappers/stats ftq

	$LKP_SRC/programs/wrappers/stats time ftq.time
